package soulyaroslav.library.animation;
...
public class MorphingAnimator {
    ...
    public MorphingAnimator(@NonNull Params params) {
        this.params = params;
    }
    ...
    public static class Params {
        ...
        private MorphingAnimator.Listener animationListener;
        ...
        public Params listener(@NonNull MorphingAnimator.Listener animationListener) {
